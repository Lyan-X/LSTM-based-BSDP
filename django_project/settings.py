...
SECRET_KEY = 'django-insecure-7^v&z!%_g#$&s^f9@x5y7#k&*()_+=-0987654321'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'bike_dispatch_platform' / 'templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    BASE_DIR / 'bike_dispatch_platform' / 'static',
]
